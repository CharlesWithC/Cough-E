...
def generate_audio_header(audio, audio_len, suffix, output_dir):
    ...
    with open(os.path.join(output_dir, filename), 'w') as f:
        ...
        f.write("#ifndef FXP_MODE\n")
        f.write("#define AUDIO_INPUT_TYPE cough_audio_sample_t\n")
        f.write("#else\n")
        f.write("#define AUDIO_INPUT_TYPE float\n")
        f.write("#endif\n\n")
        f.write("/* \n")
        ...
        f.write("{\n")
        f.write("    AUDIO_INPUT_TYPE air[AUDIO_LEN];\n")
...
def generate_imu_header(imu_data, imu_len, suffix, output_dir):
    ...
    with open(os.path.join(output_dir, filename), 'w') as f:
        ...
        f.write("*/\n\n")
        f.write("#ifndef FXP_MODE\n")
        f.write("#define IMU_INPUT_TYPE cough_imu_sample_t\n")
        f.write("#else\n")
        f.write("#define IMU_INPUT_TYPE float\n")
        f.write("#endif\n")
        f.write(f"static const IMU_INPUT_TYPE imu_in[IMU_LEN][6] = {{\n\n")
